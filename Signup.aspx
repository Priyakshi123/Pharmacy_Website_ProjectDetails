<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="PHARMACYFINAL.Signup" %>
        ...
        <div class="card">
            <div class ="card-body">
                ...
                <div class="row">
                    <div class="col">
                        <center>
                            ...
                            <img src="images/userlogin.png" width="150" height="80" />
                            </center>
                        </div>
                    </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <center>
                        <span class="badge badge-badge-pill badge-info">Credentials</span></center></div></div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <asp:Button class="btn btn-success btn-block" ID="Button2" runat="server" Text="Signup" OnClick="Button2_Click" Width="700px" />
